...
-----------------------------------------------------------
weizPVP_CoreTooltip =
  weizPVP_CoreTooltip or CreateFrame("GameTooltip", "weizPVP_CoreTooltip", UIParent, "GameTooltipTemplate")
...
local function BuildTargetedIcon()
  ...
  -- : Targeted Icon
  weizPVP_CoreFrame.TargetedIcon =
    weizPVP_CoreFrame.TargetedIcon or weizPVP_CoreFrame.OuterIconFrame:CreateTexture(nil, "OVERLAY")
