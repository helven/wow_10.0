...
function NS.CoreUI.BuildBars()
  ...
  for k = 1, NS.Options.Bars.MaxNumBars do
    NS.CoreUI.Bar[k] =
      NS.CoreUI.Bar[k] or CreateFrame("StatusBar", "weizPVP_PlayerBar" .. k, weizPVP_CoreFrame.ScrollFrame.ListFrame)
    ...
    --: Level
    NS.CoreUI.Bar[k].Level =
      NS.CoreUI.Bar[k].Level or NS.CoreUI.Bar[k]:CreateFontString(nil, "ARTWORK", GameFontNormal, 2)
    ...
    --: Guild
    NS.CoreUI.Bar[k].Guild =
      NS.CoreUI.Bar[k].Guild or NS.CoreUI.Bar[k]:CreateFontString(nil, "ARTWORK", GameFontNormal, 2)
    ...
    --> Button
    NS.CoreUI.Bar[k].Button =
      NS.CoreUI.Bar[k].Button or CreateFrame("Button", nil, NS.CoreUI.Bar[k], "InsecureActionButtonTemplate")
