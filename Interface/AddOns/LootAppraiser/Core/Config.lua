...
--------------------------------------------------------------------------
		...
		supportDiscordHeader = { order = 95, type = "header", name = "Suggestions and Support", },
		
		discordSupportSection = {
		type = "input", order = 96, name = "LootAppraiser Discord:", desc = "Join the official LootAppraiser Discord to send in suggestions and get support.", width = "full", 
			get = function(info)
				return LA.CONST.LADISCORD
			end,
			set = function(info, value)
				value = info
            end,
