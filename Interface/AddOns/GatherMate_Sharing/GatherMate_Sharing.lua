...
local Sharing = GatherMate2:NewModule("Sharing","AceEvent-3.0","AceComm-3.0")
...
function Sharing:OnMessage(prefix, message, distribution, sender)
	...
	if cmd == 'A' and db.syncAdds then
		...
		actingOnComm = true
		if GatherMate2.AddNodeChecked then
			GatherMate2:AddNodeChecked(zone, x, y, nodeType, nodeName)
		else
