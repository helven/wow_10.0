...
classValues["TRINKET"] = format("|T%s:16|t %s & %s", E.ICO.TRINKET, INVTYPE_TRINKET, INVTYPE_WEAPONMAINHAND)
...
local customSpellInfo = {
	...
	item = {
		...
		name = format("%s & %s: %s", INVTYPE_TRINKET, INVTYPE_WEAPONMAINHAND, L["Item ID (Optional)"]),
