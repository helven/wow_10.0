...
L["A stop error has occurred but no need to worry.  It can happen from time to time.  Click the reload button to resolve it."] = "Une erreur critique s'est produite, mais ne vous inquiétez pas. Ça peut arriver de temps en temps. Cliquez sur le bouton de rechargement pour résoudre ça."
...
L["If checked, you can move the battlefield map by dragging any of its borders.|n|nYou can resize the battlefield map by dragging the bottom-right corner."] = "Si coché, vous pouvez déplacer la carte du champ de bataille en faisant glisser l'une de ses bordures.|n|nVous pouvez redimensionner la carte du champ de bataille en faisant glisser le coin inférieur droit."
...
L["Your game account does not have Two-Factor Authentication (2FA) enabled.|n|nIf you use premade group finder to make a Mythic+ dungeon group for your own key, you may see a stop error when the game tries to set the activity title to your key level.  To clear this error, reload your UI.|n|nTo avoid seeing this error, enable Two-Factor Authentication (2FA) on your game account."] = "L'authentification à double facteur (2FA) n'est pas activée sur votre compte.|n|nSi vous utilisez l'outil de recherche de groupe prédéfini pour créer un groupe de donjon Mythic+ pour votre propre clé, une erreur peut s'afficher lorsque le jeu tente de définir le titre de l'activité de votre niveau clé. Pour effacer cette erreur, rechargez votre interface.|n|nPour éviter de voir cette erreur, activez l'authentification à double facteur (2FA) sur votre compte."
